                ...
                <form class="px-6 py-8 "method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <a href="#" class="flex mb-6">
                            <span class="font-extrabold text-2xl first-letter:text-sky-500 tracking-wider">name<span
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm text-sky-500 border-b border-dashed border-sky-500"
