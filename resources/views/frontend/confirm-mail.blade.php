...
<body class="h-screen w-screen flex justify-center items-center bg-[url('../backend/images/bg-auth.jpg')] relative bg-cover bg-top after:absolute after:inset-0 after:bg-black/50 after:-z-10">
    <div class="xl:w-1/2 md:w-3/4 w-full m-8 whitespace-nowrap">
        <div class="flex bg-white overflow-hidden rounded-xl">
            ...
            <div class="lg:w-1/2 w-full">
                <div class="px-6 py-8">
                    <a href="index.html" class="flex justify-start mb-8">
                        <span class="font-extrabold text-2xl tracking-wider">Trang admin</span>
                    </a>
