...
<body class="onepage inner-page">
    ...
    <!-- breadcrumb area -->
    <div class="rts-breadcrumb-area ptb--190">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <div class="rts-contact-page-area rts-section-gapBottom">
        <div class="container">
            <div class="row g-5">
                <!-- single contact area -->
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-contact-one-inner sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="thumbnail">
                            <img src="assets/frontend/images/contact/01.png" alt="">
                        </div>
                        <div class="content">
                            <div class="icone">
                                <img src="assets/frontend/images/contact/shape/01.svg" alt="">
                            </div>
                            <div class="info">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-contact-one-inner sal-animate" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="thumbnail">
                            <img src="assets/frontend/images/contact/02.png" alt="">
                        </div>
                        <div class="content">
                            <div class="icone">
                                <img src="assets/frontend/images/contact/shape/02.svg" alt="">
                            </div>
                            <div class="info">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="single-contact-one-inner sal-animate" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                        <div class="thumbnail">
                            <img src="assets/frontend/images/contact/03.png" alt="">
                        </div>
                        <div class="content">
                            <div class="icone">
                                <img src="assets/frontend/images/contact/shape/03.svg" alt="">
                            </div>
                            <div class="info">
    ...
    <div class="rts-section-gapBottom rts-contact-form-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="contact-form-wrapper">
                        ...
                        <form action="#">
                            ...
                            <a href="#" class="rts-btn btn-main-3 mt--30">Submit Message</a>
                        </form>
                    </div>
                </div>
            </div>
