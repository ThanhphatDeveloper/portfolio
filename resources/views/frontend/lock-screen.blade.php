            ...
            <div class="lg:w-1/2 w-full">
                <div class="px-6 py-8">
                    <div class="flex justify-between items-start">
                        <h5 class="text-xl font-bold text-gray-700 mb-6">Lock Screen</h5>
                    ...
                    <div class="flex flex-col justify-center items-center mb-4">
                        <img src="assets/backend/images/user.jpg" class="rounded-full w-24 h-24 mb-4 p-1 border" alt="thumbnail">
                        <h5 class="text-base text-gray-800 mb-2 font-semibold">Paul D. Shelly</h5>
                        <p class="text-gray-500 text-center mb-6 text-sm mt-3">Enter your password to access the admin. </p>
                    </div>

                    <div class="flex justify-center mb-6">
                        <button class="inline-flex items-center justify-center rounded py-1.5 px-3 text-sm font-semibold transition-all w-full text-white bg-sky-500"> Unlock </button>
                    </div>
                    ...
                    <p class="text-gray-500 text-center">Not you ? return <a href="auth-login.html" class="text-sky-500 ms-1"><b>Login</b></a></p>
                </div>
            </div>
        </div>
    </div>
