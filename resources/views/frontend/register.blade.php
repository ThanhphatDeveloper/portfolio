    ...
    <div class="xl:w-1/2 md:w-3/4 w-full m-8 whitespace-nowrap">
        <div class="flex bg-white overflow-hidden rounded-xl">
            ...
            <div class="lg:w-1/2 w-full">
                <form class="px-6 py-8 "method="POST" action="{{ route('register') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input id="Name"
                            ...
                            type="text" placeholder="Enter your Name @error('name') is-invalid @enderror"
                    ...
                    <p class="text-gray-500 text-center">Already have an account ?<a href="{{route('login')}}"
