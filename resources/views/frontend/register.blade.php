            ...
            <div class="lg:w-1/2 w-full">
                <div class="px-6 py-8">
                    <div class="flex justify-between items-start">
                        <h5 class="text-xl font-bold text-gray-700 mb-6">Register</h5>
                    ...
                    <div class="mb-4">
                        <label class="flex font-semibold text-base mb-2" for="Name">Name</label>
                        <input id="Name" class="form-input font-normal rounded block w-full border-gray-200 text-sm focus:border-gray-300 focus:ring-0 bg-white" type="text" placeholder="Enter your Name   ">
                    </div>
                    ...
                    <div class="flex justify-center mb-6">
                        <button class="inline-flex items-center justify-center rounded py-1.5 px-3 text-sm font-semibold transition-all w-full text-white bg-sky-500"> Register Now </button>
                    </div>
                    ...
                    <p class="text-gray-500 text-center">Already have an account ?<a href="auth-login.html" class="text-sky-500 ms-1"><b>Login</b></a></p>
                </div>
            </div>
        </div>
    </div>
